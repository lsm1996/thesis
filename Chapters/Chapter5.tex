...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/MicroUSB.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/voltage_stepdown.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/SCL_lines.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/I2C_Expander.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/vga.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/LED_backlight.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/modem.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/barometer.png}\centering
...
\begin{figure}
	\includegraphics[width=0.5\linewidth]{Figures/smartcard.png}\centering
