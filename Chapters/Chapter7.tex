...
Many of these errors were trivial and were solved in a number of hours, however some of the trickier problems to solve took a number of days.\todo{Give examples of tricky problem. Then rewrite next sentence to flow. Such as (These problems caused the components they affected, such as the XXX, to be left until the end of the project.)}
...
When the design was imported from the schematics it was found that there were a few components which were neglected during the initial schematic design. This resulted in parts such as the XXX\todo{Insert forgotten part name}, had yet to have a footprint attached to it. 
